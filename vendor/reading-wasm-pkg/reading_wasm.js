/* @ts-self-types="./reading_wasm.d.ts" */
...
export class Reader {
     ...
     * @param {string | null} [user_csv]
     * @returns {Reader}
     */
    static from_zstd(compressed, user_csv) {
        const ptr0 = passArray8ToWasm0(compressed, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(user_csv) ? 0 : passStringToWasm0(user_csv, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.reader_from_zstd(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Reader.__wrap(ret[0]);
    }
    /**
    ...
    constructor(dictionary) {
        const ptr0 = passArray8ToWasm0(dictionary, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.reader_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    tokenize(text) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.reader_tokenize(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./reading_wasm_bg.js": import0,
    };
}

const ReaderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_reader_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('reading_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
